...
export class IIQCommands {
    ...
    if (!classPath) {
      ...
      if (!classPath) {
        ...
        if (classPath === undefined) {
          vscode.window.showErrorMessage(`Please specify the path to IIQ libraries so that your file can get compiled`);
          return;
        }
  ...
  public async getObject() {
    ...
    const theClass = await vscode.window.showQuickPick(classes,
